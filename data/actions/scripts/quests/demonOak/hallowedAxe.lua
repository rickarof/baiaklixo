...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	local spectators, hasMonsters = Game.getSpectators(POSITION_DEMON_OAK, false, false, 9, 9, 6, 6), false
	...
	if isDefeated then
		player:teleportTo(Position(22, 112, 8))
	...
	player:say(isLastCut and 'HOW IS THAT POSSIBLE?!? MY MASTER WILL CRUSH YOU!! AHRRGGG!' or config.sounds[math.random(#config.sounds)], TALKTYPE_MONSTER_YELL, false, player, POSITION_DEMON_OAK)
